...
### What is it?
MB Loader uses Minecraft as a base, applies necessary changes on top of it and opens the game completely separate from the Minecraft app. This means data is kept separately from Minecraft (existing worlds, texture packs or anything else won't show up on MB Loader).  
